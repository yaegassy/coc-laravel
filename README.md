...
- Completions
  ...
  - [TODO] Eloquent completion
    - Use `_ide_helper_models.php` generated by [laravel-ide-helper](https://github.com/barryvdh/laravel-ide-helper) to add some features. For example, input completion of the actual table and column names associated with each model, etc.
- Definitions
